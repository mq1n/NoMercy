...
#define SysInfoLog(_x_, ...)  DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_INFO_LEVEL, _x_, __VA_ARGS__)
#define SysErrorLog(_x_, ...) DbgPrintEx(DPFLTR_IHVDRIVER_ID, DPFLTR_ERROR_LEVEL, _x_, __VA_ARGS__); 
