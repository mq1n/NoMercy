...
PsProcessCallback::PsProcessCallback(PCREATE_PROCESS_NOTIFY_ROUTINE NotifyCallback) : 
	PsProcessCallback()
{
...
PsThreadCallback::PsThreadCallback(PCREATE_THREAD_NOTIFY_ROUTINE NotifyCallback) : 
	PsThreadCallback() 
{
    SetupCallback(NotifyCallback);
}
...
PsImageCallback::PsImageCallback(PLOAD_IMAGE_NOTIFY_ROUTINE NotifyCallback) : 
	PsImageCallback() 
{
    SetupCallback(NotifyCallback);
}
