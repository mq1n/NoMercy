...
namespace IO 
{
	namespace IOPL 
	{
		...
		PVOID GetTrapFrame() 
		{
			return reinterpret_cast<PVOID>(reinterpret_cast<SIZE_T>(IoGetInitialStack()) - KTrapFrame32Size);
		}

		PULONG GetEFlagsPtr(PVOID KTrapFramePtr) 
		{
			return reinterpret_cast<PULONG>(reinterpret_cast<SIZE_T>(KTrapFramePtr) + EFlagsOffsetInKTrapFrame32	);
		}
