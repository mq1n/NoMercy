...
class Atomic32 final
{
	public:
		...
		explicit Atomic32(LONG InitialValue) :
...
class Atomic64 final 
{
	public:
		...
		explicit Atomic64(LONG64 InitialValue) : 
			AtomicValue(InitialValue)
		{
		}
		~Atomic64() = default;
...
class AtomicPointer final
{
	public:
		...
		explicit AtomicPointer(PVOID InitialValue = NULL) : 
			AtomicValue(InitialValue) 
		{
		}
