...
#include "NM_Index.h"
#include "NM_Main.h"
#include <rewolf-wow64ext/src/internal.h>
#include <rewolf-wow64ext/src/wow64ext.h>
#include <rewolf-wow64ext/src/CMemPtr.h>

#pragma warning(push)
#pragma warning(disable : 4409 4838)
...
DWORD64 ReadProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T *lpNumberOfBytesRead)
{
	...
	if (lpNumberOfBytesRead) *lpNumberOfBytesRead = (SIZE_T)numOfBytes;
	return ret;
}
...
DWORD64 WriteProcessMemory64(HANDLE hProcess, DWORD64 lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T *lpNumberOfBytesWritten)
{
	...
	if (lpNumberOfBytesWritten)  *lpNumberOfBytesWritten = (SIZE_T)numOfBytes;
	return ret;
}
